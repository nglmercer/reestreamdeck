import  { createDBManager, databases, observer } from "./utils/indexedDB";
...
let appList = [];
socketManager.onMessage("getapps", (data) => {
  appList = data;
});
document.addEventListener('DOMContentLoaded', function () {
  ...
  setTimeout(() => {
    ...
    const formModal = new FormModal('#modal', '#dynamicForm', options);
